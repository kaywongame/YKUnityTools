...
public class UTFlyControl_1: MonoBehaviour
{
   ...
   void Update()
   {
      if (Input.GetKeyUp(KeyCode.X)) { GetComponent<MouseLook>().enabled = false; }
      if (Input.GetKeyUp(KeyCode.Z)) { GetComponent<MouseLook>().enabled = true; }
