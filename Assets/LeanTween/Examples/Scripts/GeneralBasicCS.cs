...
public class GeneralBasicCS : MonoBehaviour {
    ...
    void Start () {
        ...
        // Rotate Example
        //LeanTween.rotateAround( avatarRotate, Vector3.forward, 360f, 5f).setEase(LeanTweenType.easeInExpo);
        id = LeanTween.rotateAround(avatarRotate, Vector3.forward, 360f, 5f).setEase(curve).id;
		...
		id2 = LeanTween.delayedCall(gameObject, 5f, advancedExamples).id;
